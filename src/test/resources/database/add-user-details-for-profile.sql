insert into users (id, email, password) values (1, 'test1@example.com', '$2a$10$RRsmVlrXUGr0j5JtwQuEcOHcwIbSi.Qz60jMimNl5ML9fTcwc.TSu')
insert into users (id, email, password) values (2, 'test2@example.com', '$2a$10$RRsmVlrXUGr0j5JtwQuEcOHcwIbSi.Qz60jMimNl5ML9fTcwc.TSu')
insert into users (id, email, password) values (3, 'test3@example.com', '$2a$10$RRsmVlrXUGr0j5JtwQuEcOHcwIbSi.Qz60jMimNl5ML9fTcwc.TSu')
